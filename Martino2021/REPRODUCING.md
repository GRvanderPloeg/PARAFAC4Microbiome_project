...
`registry.codeocean.com/published/2e1d14a7-11a8-454d-a275-9d541b221fbc:v1`
...
docker run --platform linux/amd64 --rm \
  ...
  registry.codeocean.com/published/2e1d14a7-11a8-454d-a275-9d541b221fbc:v1 bash run.sh
```
